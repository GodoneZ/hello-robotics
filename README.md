...
| [第十二章 移动操作综合实践：全场景自主导航操作](./docs/chapter12/第十二章%20移动操作综合实践：全场景自主导航操作.md)                   | 结合建图与导航算法，以及操作控制，实现全场景的移动操作任务              | ✅    |
...
| [前沿算法1 ACoT-VLA](./sota_algorithm/g2/前沿算法1-acotvla/docs/ACoT-VLA%20视觉语言动作模型部署.md) | 通过显式粗动作参考与隐式动作先验，引导 G2 生成精细动作并完成三色物块入盒任务 | ✅ |
| [前沿算法2 Fast-WAM 世界动作模型复现与部署](./sota_algorithm/g2/前沿算法2-Fast-WAM/docs/Fast-WAM%20世界动作模型复现与部署.md) | 讲解 Fast-WAM 原理，完成 G2 三相机数据、模型训练、推理服务与仿真评测 | ✅ |
